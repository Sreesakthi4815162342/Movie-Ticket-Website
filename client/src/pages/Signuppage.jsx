      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
              ...
              <div className="mt-2">
                <input id="user" name="name" type="text" required autoComplete="text" className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 input validator" pattern="[A-Za-z][A-Za-z0-9\-]*" minLength="3" maxLength="30" placeholder='User name' onChange={handleChange}/>
              </div>
            </div>
            <div>
